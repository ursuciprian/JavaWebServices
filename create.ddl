...
CREATE TABLE members (MEMBERID INTEGER NOT NULL, BIRTHDATE DATE, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PRIMARY KEY (MEMBERID))
...
CREATE TABLE cities (CITYID INTEGER NOT NULL, CITYNAME VARCHAR(255), PRIMARY KEY (CITYID))
ALTER TABLE CLUB ADD CONSTRAINT FK_CLUB_MEMBER_MEMBERID FOREIGN KEY (MEMBER_MEMBERID) REFERENCES members (MEMBERID)
